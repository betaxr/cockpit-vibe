...
## Team View Fix - Multiple Agent Silhouettes

### Multiple Agents Display
- [x] Show multiple full-body silhouettes for teams with multiple agents
- [x] Each silhouette filled as bar chart based on utilization
- [x] Marketing (3 agents) = 3 silhouettes side by side

### Hover Popup Legend
- [x] Remove static ProcessLegend from view
- [x] Add hover-triggered popup at mouse position (HoverLegend component)
- [x] Popup shows color explanations (Restkapazität, Geplante Prozesse, etc.)
- [x] Popup disappears when mouse leaves silhouette area
- [x] 21 unit tests passing
